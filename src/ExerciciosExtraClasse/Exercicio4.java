...
public class Exercicio4 {
	/*
	 * Desenvolver um programa em Java que permita cadastrar carros com suas
	 * respectivas marcas, placas e anos de fabricação. O programa deve fornecer um
	 * menu para realizar consultas e operações sobre os carros cadastrados.
	 */

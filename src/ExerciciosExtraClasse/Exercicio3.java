...
public class Exercicio3 {
	...
	public static void main(String[] args) {
		/*
		 * Desenvolver um programa em Java que permita cadastrar alunos com seus
		 * respectivos nomes, alturas e sexos. O programa deve fornecer um menu com
		 * opções para realizar análises e consultas sobre as informações cadastradas.
		 */
